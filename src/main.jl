...
#    n_its = 1000, n_burn = 10000, n_thin = 1, n_chains = 200, deterministic_γ = false, memory = false, parallel = true, check_chain_epochs = 3, save_burnt = true
#);
...
#MCMCDiagnosticTools.rhat(randn(10000, 50, 25))